  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-white to-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-20 left-10 w-72 h-72 bg-primary-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"
        ...
        />
        <div
          className="absolute -bottom-8 left-1/2 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div className="animate-slide-in-up">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
              Turn Tough Subjects into <span className="gradient-text">Visual Stories</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 group-hover:translate-x-1 transition-transform">
                  <path
                    fillRule="evenodd"
                    d="M16.72 7.72a.75.75 0 0 1 1.06 0l5.25 5.25a.75.75 0 0 1 0 1.06l-5.25 5.25a.75.75 0 1 1-1.06-1.06l3.97-3.97H3a.75.75 0 0 1 0-1.5h17.69l-3.97-3.97a.75.75 0 0 1 0-1.06Z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
      ...
      <svg className="absolute left-1/2 -bottom-24 w-[120%] -translate-x-1/2 max-w-none" viewBox="0 0 1200 200" xmlns="http://www.w3.org/2000/svg">
        <defs>
